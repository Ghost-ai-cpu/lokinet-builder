...
#define MyAppName "worktips-network"
#define MyAppVersion "0.0.3"
#define MyAppPublisher "Worktips Project"
#define MyAppURL "https://worktips.project"
#define MyAppExeName "worktipsnet.exe"
; change this to avoid compiler errors  -despair
#define DevPath "D:\dev\llarpd-builder\"
#include <idp.iss>

; inno setup script ©2018 rick v for worktips project
; all rights reserved? not sure which licence we're 
; under. worktipsnet appears to be under the zlib licence
...
VersionInfoDescription=worktipsnet installer for win32
VersionInfoTextVersion=0.0.3
VersionInfoProductName=worktips-network
...
VersionInfoCopyright=Copyright ©2018 Worktips Project
...
Source: "{#DevPath}worktipsnet-bootstrap.exe"; DestDir: "{tmp}"; Flags: deleteafterinstall
...
begin
  ...
  begin
    ...
    idpAddFile('https://github.com/despair86/worktipsnet-builder/raw/master/contrib/tuntapv9-ndis/tap-windows-9.21.2.7z', ExpandConstant('{tmp}\tuntapv9_n6.7z'));
  end;
